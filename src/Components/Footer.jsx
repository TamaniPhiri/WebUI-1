  ...
  return (
    <footer class="text-gray-400 bg-gray-800 body-font">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-wrap justify-evenly md:text-left text-center -mb-10 -mx-4">
      ...
      <div class="border-t border-gray-800">
        <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
          <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
            ...
            <button class="inline-flex text-gray-800 bg-lime-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded">
              Contact
            </button>
