  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <div class="flex mx-auto border-2 border-lime-400 rounded overflow-hidden mt-6">
        <button class="py-1 px-4 bg-lime-400 text-gray-800 focus:outline-none">Monthly</button>
    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
          ...
          <p class="flex items-center text-gray-400 mb-2">
            <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 text-lime-400 rounded-full flex-shrink-0">
          ...
          <button class="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-700 rounded">Subscribe
      ...
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-lime-400 flex flex-col relative overflow-hidden">
          <span class="bg-lime-400 text-gray-800 px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">POPULAR</span>
          ...
          <button class="flex items-center mt-auto text-gray-800 bg-lime-400 border-0 py-2 px-4 w-full focus:outline-none hover:bg-white rounded">Subscribe
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>
