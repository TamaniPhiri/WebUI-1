  ...
  return (
    <section class="text-gray-800 bg-white body-font">
        <div class="flex flex-col text-center w-full">
            <h1 class="sm:text-4xl text-3xl font-medium title-font mt-10 text-gray-800">Testimonials</h1>
        </div>
